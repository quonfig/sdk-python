...
def test_reason_is_static_for_feature_flag_with_only_always_true_rules() -> None:
    ...
    assert aggregator_post(agg, 'evaluation_summary', endpoint='/api/v1/telemetry') == [{'key': 'always.true', 'type': 'FEATURE_FLAG', 'value': True, 'value_type': 'bool', 'count': 1, 'reason': 1, 'selected_value': {'bool': True}, 'summary': {'config_row_index': 0, 'conditional_value_index': 0}}]
...
def test_reason_is_targeting_match_when_config_has_targeting_rules_but_evaluation_falls_through() -> None:
    ...
    assert aggregator_post(agg, 'evaluation_summary', endpoint='/api/v1/telemetry') == [{'key': 'my-test-key', 'type': 'CONFIG', 'value': 'my-test-value', 'value_type': 'string', 'count': 1, 'reason': 2, 'selected_value': {'string': 'my-test-value'}, 'summary': {'config_row_index': 0, 'conditional_value_index': 1}}]
...
def test_reason_is_targeting_match_when_a_targeting_rule_matches() -> None:
    ...
    assert aggregator_post(agg, 'evaluation_summary', endpoint='/api/v1/telemetry') == [{'key': 'feature-flag.integer', 'type': 'FEATURE_FLAG', 'value': 5, 'value_type': 'int', 'count': 1, 'reason': 2, 'selected_value': {'int': 5}, 'summary': {'config_row_index': 0, 'conditional_value_index': 0}}]
...
def test_reason_is_split_for_weighted_value_evaluation() -> None:
    ...
    assert aggregator_post(agg, 'evaluation_summary', endpoint='/api/v1/telemetry') == [{'key': 'feature-flag.weighted', 'type': 'FEATURE_FLAG', 'value': 2, 'value_type': 'int', 'count': 1, 'reason': 3, 'selected_value': {'int': 2}, 'summary': {'config_row_index': 0, 'conditional_value_index': 0, 'weighted_value_index': 2}}]
...
def test_reason_is_targeting_match_for_feature_flag_fallthrough_with_targeting_rules() -> None:
    ...
    assert aggregator_post(agg, 'evaluation_summary', endpoint='/api/v1/telemetry') == [{'key': 'feature-flag.integer', 'type': 'FEATURE_FLAG', 'value': 3, 'value_type': 'int', 'count': 1, 'reason': 2, 'selected_value': {'int': 3}, 'summary': {'config_row_index': 0, 'conditional_value_index': 1}}]
...
def test_evaluation_summary_deduplicates_identical_evaluations() -> None:
    ...
    assert aggregator_post(agg, 'evaluation_summary', endpoint='/api/v1/telemetry') == [{'key': 'brand.new.string', 'type': 'CONFIG', 'value': 'hello.world', 'value_type': 'string', 'count': 5, 'reason': 1, 'selected_value': {'string': 'hello.world'}, 'summary': {'config_row_index': 0, 'conditional_value_index': 0}}]
...
def test_evaluation_summary_creates_separate_counters_for_different_rules_of_same_config() -> None:
    ...
    assert aggregator_post(agg, 'evaluation_summary', endpoint='/api/v1/telemetry') == [{'key': 'feature-flag.integer', 'type': 'FEATURE_FLAG', 'value': 5, 'value_type': 'int', 'count': 1, 'reason': 2, 'selected_value': {'int': 5}, 'summary': {'config_row_index': 0, 'conditional_value_index': 0}}, {'key': 'feature-flag.integer', 'type': 'FEATURE_FLAG', 'value': 3, 'value_type': 'int', 'count': 1, 'reason': 2, 'selected_value': {'int': 3}, 'summary': {'config_row_index': 0, 'conditional_value_index': 1}}]
