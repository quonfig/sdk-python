...
def test_reports_evaluation_summary() -> None:
    ...
    assert aggregator_post(agg, 'evaluation_summary', endpoint='/api/v1/telemetry') == [{'key': 'my-test-key', 'type': 'CONFIG', 'value': 'my-test-value', 'value_type': 'string', 'count': 1, 'reason': 2, 'summary': {'config_row_index': 0, 'conditional_value_index': 1}}, {'key': 'my-string-list-key', 'type': 'CONFIG', 'value': ['a', 'b', 'c'], 'value_type': 'string_list', 'count': 1, 'reason': 1, 'summary': {'config_row_index': 0, 'conditional_value_index': 0}}, {'key': 'feature-flag.integer', 'type': 'FEATURE_FLAG', 'value': 3, 'value_type': 'int', 'count': 2, 'reason': 2, 'summary': {'config_row_index': 0, 'conditional_value_index': 1}}, {'key': 'feature-flag.weighted', 'type': 'FEATURE_FLAG', 'value': 2, 'value_type': 'int', 'count': 1, 'reason': 3, 'summary': {'config_row_index': 0, 'conditional_value_index': 0, 'weighted_value_index': 2}}]
