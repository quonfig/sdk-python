...
def test_can_return_a_value_provided_by_an_environment_variable_after_type_coercion(config_client) -> None:
    c = config_client
...
def test_can_decrypt_and_return_a_secret_value_with_decryption_key_in_in_env_var(config_client) -> None:
    c = config_client
