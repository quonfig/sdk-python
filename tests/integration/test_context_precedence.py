...
def test_returns_the_correct_flag_value_when_local_context_clobbers_global_context_1(config_client) -> None:
    c = config_client
    result = c.is_feature_enabled('mixed.case.property.name', contexts={'user': {'isHuman': 'verified'}})
    assert result is True
...
def test_returns_the_correct_flag_value_when_local_context_clobbers_global_context_2(config_client) -> None:
    c = config_client
    result = c.is_feature_enabled('mixed.case.property.name', contexts={'user': {'isHuman': '?'}})
    assert result is False
...
def test_returns_the_correct_flag_value_when_block_context_clobbers_global_context_1(config_client) -> None:
    c = config_client
    result = c.is_feature_enabled('mixed.case.property.name', contexts={'user': {'isHuman': '?'}})
    assert result is False
...
def test_returns_the_correct_flag_value_when_block_context_clobbers_global_context_2(config_client) -> None:
    c = config_client
    result = c.is_feature_enabled('mixed.case.property.name', contexts={'user': {'isHuman': 'verified'}})
    assert result is True
...
def test_returns_the_correct_flag_value_when_local_context_clobbers_block_context_1(config_client) -> None:
    c = config_client
    result = c.is_feature_enabled('mixed.case.property.name', contexts={'user': {'isHuman': '?'}})
    assert result is False
...
def test_returns_the_correct_flag_value_when_local_context_clobbers_block_context_2(config_client) -> None:
    c = config_client
    result = c.is_feature_enabled('mixed.case.property.name', contexts={'user': {'isHuman': 'verified'}})
    assert result is True
...
def test_returns_the_correct_get_value_when_local_context_clobbers_global_context_1(config_client) -> None:
    c = config_client
    result = c.get_string('basic.rule.config', contexts={'user': {'email': 'test@prefab.cloud'}})
    assert result == 'override'
...
def test_returns_the_correct_get_value_when_local_context_clobbers_global_context_2(config_client) -> None:
    c = config_client
    result = c.get_string('basic.rule.config', contexts={'user': {'email': 'test@example.com'}})
    assert result == 'default'
...
def test_returns_the_correct_get_value_when_block_context_clobbers_global_context_1(config_client) -> None:
    c = config_client
    result = c.get_string('basic.rule.config', contexts={'user': {'email': 'test@example.com'}})
    assert result == 'default'
...
def test_returns_the_correct_get_value_when_block_context_clobbers_global_context_2(config_client) -> None:
    c = config_client
    result = c.get_string('basic.rule.config', contexts={'user': {'email': 'test@prefab.cloud'}})
    assert result == 'override'
...
def test_returns_the_correct_get_value_when_local_context_clobbers_block_context_1(config_client) -> None:
    c = config_client
    result = c.get_string('basic.rule.config', contexts={'user': {'email': 'test@example.com'}})
    assert result == 'default'
...
def test_returns_the_correct_get_value_when_local_context_clobbers_block_context_2(config_client) -> None:
    c = config_client
    result = c.get_string('basic.rule.config', contexts={'user': {'email': 'test@prefab.cloud'}})
    assert result == 'override'
